...
<head>
  <title>El 2020 en la calle</title>
  <meta charset="utf-8">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap" id="home-section">
    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
          ...
          <div class="site-logo">
            <a href="index.html" class="text-black"><span class="text-primary">EL 2020 EN LA CALLE</a>
          </div>
          ...
          <nav class="site-navigation text-center ml-auto" role="navigation">
            ...
            <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
              ...
              <li><a href="#discover-section" class="nav-link">El gran día</a></li>
    ...
    <div class="d-block d-md-flex intro-engage">
      <div class="">
        <h2>DONEMOS</h2>
        <p>Estamos recibiendo donaciones para que las personas en situación de calle celebren con ganas.</p>
      </div>
      <div>
        <h2>COMPARTAMOS</h2>
        <p>Acompáñanos en esta causa. Tú también puedes participar.</p>
      </div>
      <div>
        <h2>CELEBREMOS</h2>
        <p>Gritemos todos juntos: ¡FELIZ AÑO NUEVO!</p>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-lg-5 ml-auto align-self-lg-center">
            <h2 class="text-black mb-4 text-uppercase section-title">Nuestra misión</h2>
            <p class="text-black">Iniciativa de un grupo de jóvenes, que se organizaron para compartir con personas en situación de calle la noche de Año Nuevo.</p>
            <p class="text-black">Realizar una celebración a lo grande junto a todos.</p>
          </div>
        </div>
        <div class="row">
          <!-- <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
            <div class="block-counter-1">
              ...
              <span class="caption text-black">Voluntarios</span>
            </div>
          </div>
          <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
            <div class="block-counter-1">
              <span class="number">10</span>
              <span class="caption text-black">Cantidad de donaciones</span>
            </div>
          </div> -->
          <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
            <div class="block-counter-1">
              <span class="number">8</span>
              <span class="caption text-black">Cantidad de voluntarios</span>
            </div>
          </div>
          <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
            <div class="block-counter-1">
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <div class="block-heading-1">
              <h2 class="text-black text-uppercase">El gran día</h2>
              <p>Nos reuniremos en ___, todos los voluntarios, a celebrar junto a personas en situación de calle. Compartiremos junto a ellos y recibirán todo los aportes que fueron entregados por ustedes.</p>
            </div>
          </div>
        </div>
        <div class="row mb-5">
          ...
          <div class="col-lg-5 ml-auto align-self-center">
            ...
            <p class="mb-5">Este lugar queda ubicado en</p>
        ...
        <!-- <div class="row mb-5">
          ...
          <div class="col-lg-5 mr-auto align-self-center order-lg-1">
            <h3 class="text-black text-uppercase mb-4">Estamos recibiendo donaciones de:</h3>
            <p class="mb-5">Escribir donaciones</p>
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-8">
                ...
                <p>Grupo de jóvenes apasionados por ayudar.</p>
              </div>
